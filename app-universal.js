(() => {
  ...
  function ensureMainNavigation() {
    ...
    // V1.0.93: nu mai reconstruim meniul dacă are deja aceeași ordine; schimbăm doar active/href.
  ...
  // V1.0.93 - meniu stabil: pe desktop rămâne extins, iar click pe meniu nu îl restrânge automat.
  document.addEventListener('DOMContentLoaded', () => {
    const shell = document.querySelector('.app-shell');
    if (!shell) return;
